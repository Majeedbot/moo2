...
SUDO = SUDO
sudo_users = {SUDO,517537234,517537234}   
print([[
...
io.popen("cd library && wget https://raw.githubusercontent.com/Majeedbot/moo2/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Majeedbot/Files_moo/File_Bot/commands.lua") 
...
if tonumber(user_id) == tonumber(517537234) then  
var = true  
elseif tonumber(user_id) == tonumber(517537234) then
var = true  
...
os.execute('rm -rf MAJEED.lua')
os.execute('wget https://raw.githubusercontent.com/Majeedbot/moo2/main/MAJEED.lua')
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..TELANDk..''..MAJEED..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
database:sadd(bot_id.."MAJEED:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."MAJEED:blocname"..msg.chat_id_)
...
if name_TELAND then 
names_TELAND = database:smembers(bot_id.."MAJEED:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."MAJEED:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."MAJEED:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."MAJEED:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."MAJEED:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."MAJEED:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_TELANDa_new(TELAND1,TELAND2)
if TELAND2 and TELAND2.first_name_ then 
if TELAND2.first_name_:match("(.*)"..database:get(bot_id.."MAJEED:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MAJEED:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local TELAND_nnn = database:get(bot_id.."MAJEED:nump"..msg.chat_id_) or 5
local TELAND_nnn2 = database:get(bot_id.."MAJEED:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(TELAND_nnn2) == tonumber(TELAND_nnn) or tonumber(TELAND_nnn2) > tonumber(TELAND_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."MAJEED:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..TELAND2.username_.."](https://t.me/"..(TELAND2.username_ or "vvvmh")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."MAJEED:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(TELAND_nnn) - tonumber(TELAND_nnn2)).."}")
end
end
end
end
...
local TELANDChengName = database:get(bot_id.."MAJEED:Cheng:Name"..data.id_)
if not data.first_name_ then 
if TELANDChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..TELANDChengName..']')
database:del(bot_id.."MAJEED:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
...
database:set(bot_id.."MAJEED:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local TELANDChengUserName = database:get(bot_id.."MAJEED:Cheng:UserName"..data.id_)
if not data.username_ then 
if TELANDChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..TELANDChengUserName..']')
database:del(bot_id.."MAJEED:Cheng:UserName"..data.id_) 
end
end
...
database:set(bot_id.."MAJEED:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local TELANDChengPhoto = database:get(bot_id.."MAJEED:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if TELANDChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."MAJEED:Cheng:Photo"..data.id_) 
end
end
...
database:set(bot_id.."MAJEED:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
🌐┇MAJEED TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📊┇ [Source Channel](https://t.me/majeed8888)

📋┇ [TshAkE Dev](https://t.me/majeed8888)

📁┇ [Source  Files](https://t.me/majeed8888)

🌐┇ [TshAkE iNDT](https://t.me/majeed8888)
ابو طيف الداعم الاساسي :)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📧┇ [TWS TshAkE](https://t.me/majeed8888)
]]
send(msg.chat_id_, msg.id_,Text)
end
--------------------------------------------------------------------------------------------------------------
...
if DevTELANDW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Majeedbot/Files_moo/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Majeedbot/Files_moo/main/File_Bot/"..file)
if res == 200 then
...
local TEXT_SUD = database:get(bot_id..'MAJEED:TEXT_SUDO')
if TEXT_SUDO then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,MAJEED)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝗧𝗘 ━━━━━━━•*\n"
x = 0
local list = MAJEED.members_
for k, v in pairs(list) do
x = x + 1
...
zh = https.request('https://vvvzvv.ml/amirZhfa/MAJEED.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⌯︙قائمه الزخرفه* \nٴ⌯∫ٴ*•━━━━━━ 𝗧𝗘 ━━━━━━━•*ٴ⌯∫○ٴ \n"
i = 0
...
gk = https.request('https://vvvzvv.ml/amirBrg/MAJEED.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/MAJEED.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://vvvzvv.ml/amirVois/MAJEED.php')
if res == 200 then
...
MAJEED = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(MAJEED)
