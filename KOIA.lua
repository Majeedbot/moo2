...
ControllerAll = false
local ListSudos ={Sudo_Id,517537234}  
...
if UserId == 517537234 then
Status = true
elseif UserId == 517537234 then
Status = true
...
if tonumber(msg.sender.user_id) == 517537234 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 517537234 then
