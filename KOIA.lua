------------------------------------------------
-- This Source Was Developed By (yousef_labban) @yousef_labban.--
...
ControllerAll = false
local ListSudos ={Sudo_Id,5031306498}  
...
if UserId == 5031306498 then
Status = true
elseif UserId == 5031306498 then
Status = true
...
if tonumber(msg.sender.user_id) == 5031306498 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5031306498 then
...
{
{text = ' ༄ Tws 𝗬𝗨𝗦𝗦𝗘𝗙 〠', url = "https://t.me/yousef_labban"}
},
{
