...
local RunBot = io.open("MAJEED", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/MAJEED
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr MAJEED.lua
wget "https://raw.githubusercontent.com/Majeedbot/moo2/main/MAJEED.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./MAJEED.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S MAJEED -X kill
screen -S MAJEED ./MAJEED
done
]])
RunTs:close()
end
